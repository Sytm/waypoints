...
enum class OverviewSort(private val comparator: Comparator<GUIDisplayable>) : Comparator<GUIDisplayable> {
    ...
    /**
     * This sorts first by [de.md5lukas.waypoints.api.gui.GUIType] and then by name if the type matches, both ascending
     */
    ...
    /**
     * This sorts first by [de.md5lukas.waypoints.api.gui.GUIType] (descending) and then by name if the type matches (ascending)
     */
