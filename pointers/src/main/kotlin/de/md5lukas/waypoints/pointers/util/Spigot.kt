...
internal operator fun Vector.div(d: Int) = Vector(
    this.x / d,
    this.y / d,
    this.z / d,
)
...
internal fun Player.sendActualBlock(location: Location) = this.sendBlockChange(location, location.block.blockData)