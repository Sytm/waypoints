...
class Translations(
    ...
    val WAYPOINT_TELEPORT_XP_LEVEL = Translation(tl, "inventory.waypoint.teleport.xpLevel", miniMessage = tl.itemMiniMessage)
    val WAYPOINT_TELEPORT_BALANCE = Translation(tl, "inventory.waypoint.teleport.balance", miniMessage = tl.itemMiniMessage)
    val WAYPOINT_TELEPORT_MUST_VISIT = Translation(tl, "inventory.waypoint.teleport.mustVisit", miniMessage = tl.itemMiniMessage)
